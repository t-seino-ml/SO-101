...
# Override with env vars, e.g. FPS=60 ./scripts/teleop.sh, or pass extra flags:
#   ./scripts/teleop.sh --robot.max_relative_target=5
set -euo pipefail
cd "$(dirname "$0")/.."

exec uv run scripts/teleoperate.py \
